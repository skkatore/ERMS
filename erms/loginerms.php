      ...
      <div class="col-xl-10 col-lg-12 col-md-9">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="row">
                <div class="col-lg-6 d-none d-lg-block bg-login-image pt-5 pl-5"> 
                <img src="img/195548-OY9OIN-908.jpg" class = "d-block w-100"alt="" style = "border-radius:9px;">
                </div>        
                <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form class="user" method="post" action="">
                    ...
                    <p> <input type="submit" class="btn btn-primar btn-user btn-block" name="login" value="login"></p>
